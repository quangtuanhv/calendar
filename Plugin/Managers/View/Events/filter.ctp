	...
	<td colspan="7" class="text-center">
		<ul class="pagination pagination-sm" id="pagination-events">
			<?php 
				$count = ceil($total/10);
			?>
			<li><a href="javascript:void(0)" data-page="<?php echo $page - 1; ?>" data-group="" data-user="" class="prev<?php if($page == 1){echo ' hidden'; } ?>">&laquo;</a></li>
			<?php for ($i = 1; $i <= $count; $i++){ ?>
			<li <?php if($i==$page){ echo 'class="active"';} ?>><a href="javascript:void(0)" data-page="<?php echo $i; ?>" data-group="" data-user="" class="normal"><?php echo $i; ?></a></li>
			<?php } ?>
			<?php if($count > 1){ ?>
			<li><a href="javascript:void(0)" data-page="<?php echo $page + 1; ?>" data-group="" data-user="" class="next<?php if($page == $count){echo ' hidden'; } ?>">&raquo;</a></li>
			<?php } ?>
		</ul>
	</td>
</tr>