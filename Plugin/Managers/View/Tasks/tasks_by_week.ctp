<div class="alert alert-success fade in alert-dismissable alert_add_task">
	<a href="#" class="close" data-dismiss="alert" aria-label="close" title="close">×</a><strong><?php echo 'From '.$monday.' to '.$sunday.' | '.$count; ?> Tasks</strong>
</div>
<table class="table table-bordered table-hover">
	<thead>
		<tr>
			...
			?>
			<td class="date-full" style="color: <?php echo $color; ?>; background: <?php echo $bgcolor; ?>"><?php echo $list; ?></td>
			<?php } ?>
		</tr>
	</thead>
	<tbody>
