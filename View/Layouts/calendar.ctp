...
<html lang="en">
	<head>
		...
		<!-- Bootstrap CSS -->
		<link href="<?php echo $this->base; ?>/managers/css/bootstrap.min.css" rel="stylesheet">
		...
		<![endif]-->
		<!-- jQuery -->
		<script src="<?php echo $this->base; ?>/managers/js/jquery.js"></script>
		...
		<script src="<?php echo $this->base; ?>/managers/js/bootstrap.min.js"></script>
	</head>
	<body>
		<?php 
